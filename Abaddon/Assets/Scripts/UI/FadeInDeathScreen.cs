...
{
    [SerializeField]
    Transform deathScreenaParent;

    [SerializeField]
    UnityEngine.UI.Image deathScreenImage;

    [SerializeField]
    UnityEngine.UI.Image restartButtonImage;

    [SerializeField]
    UnityEngine.UI.Image darkener;

    [SerializeField]
    float timeToFadeIn = 2f;
