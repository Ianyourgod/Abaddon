...
public class UISfx : SfxPlayer
{
    ...
    [Tooltip("(volume is in 0.01 scale) How much volume you want to add to your open inventory sound effects")]
    [SerializeField] float addedOpenVolume = 0f;

    [Tooltip("(volume is in 0.01 scale) How much volume you want to add to your close inventory sound effects")]
    [SerializeField] float addedCloseVolume = 0f;
