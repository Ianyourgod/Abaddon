...
public class DoorSfx : SfxPlayer
{
    ...
    [SerializeField] AudioClip[] lockedDoorSfx;
    [Tooltip("Whether the action will play a random sound effect from the list or not")]
    [SerializeField] bool randomLockedSound = false;
    [Space]

    [Tooltip("Include all unlocked door sound effects for this door")]
    [SerializeField] AudioClip[] unlockedSfx;
    [Tooltip("Whether the action will play a random sound effect from the list or not")]
    [SerializeField] bool randomUnlockedSound = false;
    [Space]

    [Tooltip("Include all unlocking door sound effects for this door")]
    [SerializeField] AudioClip[] unlockLockedSfx;
    [Tooltip("Whether the action will play a random sound effect from the list or not")]
    [SerializeField] bool randomUnlockLockedSound = false;

    [Header("DoorSfx Attributes")]
    [Tooltip("(volume is in 0.01 scale) How much volume you want to add to your locked door sound effects")]
    [SerializeField] float addedLockedVolume = 0f;
    [Tooltip("(volume is in 0.01 scale) How much volume you want to add to your unlocked door sound effects")]
    [SerializeField] float addedUnlockedVolume = 0f;
    [Tooltip("(volume is in 0.01 scale) How much volume you want to add to your unlocking door sound effects")]
    [SerializeField] float addedUnlockLockedVolume = 0f;
