...
public class Tooltip : MonoBehaviour
{
    ...
    [Header("Objects")]
    [Tooltip(
        "Add your player object here. It has to have the \"Inventory\" script attached to it."
    )]
    ...
    [Tooltip(
        "If you have images that you want to be shown together with the tooltip itself add them here."
    )]
        ...
        if (invObject.activeSelf == true)
        {
            ...
            if (
                ...
                && (
                    ...
                    || hovered.gameObject == transform.parent.gameObject
                    || hovered.gameObject == tooltipObject
                )
            )
            {
                ShowToolTip();
    ...
    public void ShowToolTip()
    {
        foreach (Text tooltipText in tooltipTexts)
        {
            ...
            text.color = new Color(
                ...
                text.color.g,
                text.color.g,
                Mathf.Lerp(text.color.a, 1f, 0.05f)
            );
        }
        ...
        foreach (Image image in tooltipImages)
        {
            ...
            comp.color = new Color(
                ...
                comp.color.g,
                comp.color.g,
                Mathf.Lerp(comp.color.a, 1f, 0.05f)
            );
        }
        ...
        back.color = new Color(
            ...
            back.color.g,
            back.color.g,
            Mathf.Lerp(back.color.a, 1f, 0.05f)
        );
    }
    ...
    public void HideTooltip()
    {
        foreach (Text tooltipText in tooltipTexts)
        {
            ...
            text.color = new Color(
                ...
                text.color.g,
                text.color.g,
                Mathf.Lerp(text.color.a, 0f, 0.05f)
            );
        }
        ...
        foreach (Image image in tooltipImages)
        {
            ...
            comp.color = new Color(
                ...
                comp.color.g,
                comp.color.g,
                Mathf.Lerp(comp.color.a, 0f, 0.05f)
            );
        }
        ...
        back.color = new Color(
            ...
            back.color.g,
            back.color.g,
            Mathf.Lerp(back.color.a, 0f, 0.05f)
        );
    }
}
