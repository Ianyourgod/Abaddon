...
namespace BrewedInk.CRT
{
    ...
    public class CRTCameraBehaviour : MonoBehaviour
    {
        ...
        private static readonly int PropMonitorRoundness = Shader.PropertyToID(
            "_BorderOutterRound"
        );
        ...
        private static readonly int PropInnerDarkness = Shader.PropertyToID(
            "_BorderInnerDarkerAmount"
        );
        private static readonly int PropInnerGlow = Shader.PropertyToID("_CrtGlowAmount");
        private static readonly int PropInnerReflectionRadius = Shader.PropertyToID(
            "_CrtReflectionRadius"
        );
        private static readonly int PropInnerReflectionCurve = Shader.PropertyToID(
            "_CrtReflectionCurve"
        );
        ...
        {
            if (
                crtRenderSettings != null
                && crtRenderSettings.crtMaterial != null
                && _runtimeMaterial == null
            )
            {
    ...
    public struct ColorChannels
    {
        ...
        [Tooltip(
            "A greyscale value of 1 will completely make the image grey. A value of 0 leaves the image untouched."
        )]
        [Range(0, 1)]
