...
namespace BrewedInk.CRT
{
    ...
    {
        [Tooltip(
            "A value of 0 means no down-sampling. Any number above 1 will down-sample the texture by the value."
        )]
        public int pixelationAmount;

        [Tooltip(
            "Each channel controls the maximum amount of values for that channel. A value of 0 means infinite values."
        )]
        public ColorChannels maxColorChannels;

        [Tooltip(
            "0 means no dithering. 1 means all dithering. Dithering will help shade a color crunched image to look like it has more coloring that it really does. "
        ...
        {
            greenChannelMultiplier = .1f,
            redBlueChannelMultiplier = .15f,
            sizeMultiplier = 2,
        };
        ...
        public static CRTData Lerp(CRTData a, CRTData b, float t)
        {
            ...
            f.innerMonitorShineCurve = Mathf.Lerp(
                a.innerMonitorShineCurve,
                b.innerMonitorShineCurve,
                t
            );
            f.innerMonitorShineRadius = Mathf.Lerp(
                a.innerMonitorShineRadius,
                b.innerMonitorShineRadius,
                t
            );
            f.colorScans.sizeMultiplier = Mathf.Lerp(
                a.colorScans.sizeMultiplier,
                b.colorScans.sizeMultiplier,
                t
            );
            f.colorScans.greenChannelMultiplier = Mathf.Lerp(
                a.colorScans.greenChannelMultiplier,
                b.colorScans.greenChannelMultiplier,
                t
            );
            f.colorScans.redBlueChannelMultiplier = Mathf.Lerp(
                a.colorScans.redBlueChannelMultiplier,
                b.colorScans.redBlueChannelMultiplier,
                t
            );
            f.monitorColor = Color.Lerp(a.monitorColor, b.monitorColor, t);
            f.maxColorChannels.greyScale = Mathf.Lerp(
                a.maxColorChannels.greyScale,
                b.maxColorChannels.greyScale,
                t
            );
            f.maxColorChannels.blue = (int)
                Mathf.Lerp(a.maxColorChannels.blue, b.maxColorChannels.blue, t);
            f.maxColorChannels.green = (int)
                Mathf.Lerp(a.maxColorChannels.green, b.maxColorChannels.green, t);
            f.maxColorChannels.red = (int)
                Mathf.Lerp(a.maxColorChannels.red, b.maxColorChannels.red, t);
            f.pixelationAmount = (int)Mathf.Lerp(a.pixelationAmount, b.pixelationAmount, t);
            f.monitorInnerSize.height = Mathf.Lerp(
                a.monitorInnerSize.height,
                b.monitorInnerSize.height,
                t
            );
            f.monitorInnerSize.width = Mathf.Lerp(
                a.monitorInnerSize.width,
                b.monitorInnerSize.width,
                t
            );
            f.monitorOutterSize.height = Mathf.Lerp(
                a.monitorOutterSize.height,
                b.monitorOutterSize.height,
                t
            );
            f.monitorOutterSize.width = Mathf.Lerp(
                a.monitorOutterSize.width,
                b.monitorOutterSize.width,
                t
            );
